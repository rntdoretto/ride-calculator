package designpatternstrategy_test

import (
	"testing"
	"time"

	designpatternstrategy "github.com/rntdoretto/ride-calculator/07-design-pattern-strategy"
...
func TestExecute(t *testing.T) {
	...
	for _, tt := range testTable {
		t.Run(tt.name, func(t *testing.T) {
			ride := designpatternstrategy.NewRide()
