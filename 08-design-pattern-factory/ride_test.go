package designpatternfactory_test

import (
	"testing"
	"time"

	designpatternfactory "github.com/rntdoretto/ride-calculator/08-design-pattern-factory"
...
func TestExecute(t *testing.T) {
	...
	for _, tt := range testTable {
		t.Run(tt.name, func(t *testing.T) {
			ride := designpatternfactory.NewRide()
